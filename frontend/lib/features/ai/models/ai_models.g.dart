...
extension GetLocalChatSessionCollection on Isar {
  IsarCollection<LocalChatSession> get localChatSessions => this.collection();
}
...
const LocalChatSessionSchema = CollectionSchema(
  ...
  estimateSize: _localChatSessionEstimateSize,
  serialize: _localChatSessionSerialize,
  deserialize: _localChatSessionDeserialize,
  deserializeProp: _localChatSessionDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},

  getId: _localChatSessionGetId,
  getLinks: _localChatSessionGetLinks,
  attach: _localChatSessionAttach,
  version: '3.3.2',
);

int _localChatSessionEstimateSize(
  LocalChatSession object,
  List<int> offsets,
...
void _localChatSessionSerialize(
  LocalChatSession object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
LocalChatSession _localChatSessionDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = LocalChatSession();
  object.id = id;
...
P _localChatSessionDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _localChatSessionGetId(LocalChatSession object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _localChatSessionGetLinks(LocalChatSession object) {
  return [];
}

void _localChatSessionAttach(
...
extension LocalChatSessionQueryWhereSort
    on QueryBuilder<LocalChatSession, LocalChatSession, QWhere> {
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterWhere> anyId() {
...
extension LocalChatSessionQueryWhere
    on QueryBuilder<LocalChatSession, LocalChatSession, QWhereClause> {
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterWhereClause> idEqualTo(
    Id id,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterWhereClause>
  idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension LocalChatSessionQueryFilter
    on QueryBuilder<LocalChatSession, LocalChatSession, QFilterCondition> {
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterFilterCondition>
  idEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalChatSessionQueryObject
    on QueryBuilder<LocalChatSession, LocalChatSession, QFilterCondition> {}

extension LocalChatSessionQueryLinks
    on QueryBuilder<LocalChatSession, LocalChatSession, QFilterCondition> {}

extension LocalChatSessionQuerySortBy
    on QueryBuilder<LocalChatSession, LocalChatSession, QSortBy> {
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy> sortByModel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'model', Sort.asc);
    });
  }

  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy>
  sortByModelDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalChatSessionQuerySortThenBy
    on QueryBuilder<LocalChatSession, LocalChatSession, QSortThenBy> {
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy> thenByModel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'model', Sort.asc);
    });
  }
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension LocalChatSessionQueryWhereDistinct
    on QueryBuilder<LocalChatSession, LocalChatSession, QDistinct> {
  QueryBuilder<LocalChatSession, LocalChatSession, QDistinct> distinctByModel({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QDistinct>
  ...
  QueryBuilder<LocalChatSession, LocalChatSession, QDistinct> distinctByTitle({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalChatSessionQueryProperty
    on QueryBuilder<LocalChatSession, LocalChatSession, QQueryProperty> {
  QueryBuilder<LocalChatSession, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<LocalChatSession, String, QQueryOperations> modelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'model');
    });
  }

  QueryBuilder<LocalChatSession, String, QQueryOperations> providerProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'provider');
    });
  }

  QueryBuilder<LocalChatSession, String?, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'remoteId');
    });
  }

  QueryBuilder<LocalChatSession, bool, QQueryOperations> syncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'synced');
    });
  }

  QueryBuilder<LocalChatSession, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'title');
    });
  }

  QueryBuilder<LocalChatSession, DateTime, QQueryOperations>
  updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalChatMessageQueryProperty
  ...
  QueryBuilder<LocalChatMessage, String?, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'remoteId');
    });
  }
  ...
  QueryBuilder<LocalChatMessage, int, QQueryOperations> sessionIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sessionId');
    });
  }

  QueryBuilder<LocalChatMessage, bool, QQueryOperations> syncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'synced');
    });
  }
